...
crx="$2"
wget -U --header="$USER" "https://clients2.google.com/service/update2/crx?response=redirect&prodversion=49.0&x=id%3D$extensionid%26installsource%3Dondemand%26uc" -O ~/Downloads/$crx.crx
